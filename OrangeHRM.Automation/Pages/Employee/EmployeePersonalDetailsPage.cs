...
{
    public class EmployeePersonalDetailsPage : BasePage
    {

        private readonly EmployeeFormComponent form;


        public EmployeePersonalDetailsPage(IWebDriver driver) : base(driver)
        {
        ...
        public EmployeePersonalDetailsPage ModifyEmployee(EmployeeModel employeeNewData)
        {
        ...
        public EmployeeListPage GoToEmployeeList()
        {
            ...
            WaitVisible(txtSearchEmployeeId);
