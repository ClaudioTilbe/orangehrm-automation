...
{
    public class EmployeeCreateChromeTest : EmployeeTestBase
    {

        [Fact]
        public void CreateEmployee_Chrome_ShouldCreateSuccessfully()
        {
            try
            {
                LoggerHelper.Info("Starting CreateEmployee Chrome test");
