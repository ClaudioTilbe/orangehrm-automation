...
namespace OrangeHRM.Automation.Tests.Employee.Update
{
    ...
    public class EmployeeUpdateEdgeTest : EmployeeTestBase
    {

        [Fact]
        public void UpdateEmployee_Edge_ShouldUpdateSuccessfully()
        {
            try
            {
                LoggerHelper.Info("Starting UpdateEmployee Edge test");
